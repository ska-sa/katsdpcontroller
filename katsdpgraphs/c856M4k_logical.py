...
def build_physical_graph(r):
    ...
    G.add_node('sdp.ingest.1',{'port': r.get_port('sdp_ingest_1_katcp'), 'antennas':4, 'continuum_factor': 32, 'cbf_channels': 4096,\
    ...
    G.add_edge('cbf.output.1','sdp.ingest.1',{'c856M4k_spead':'{}:7148'.format(r.get_multicast_ip('c856M4k_spead'))\
               , 'input_rate':10e6})
