...
def build_physical_graph(r):
    ...
    G.add_node('sdp.ingest.1',{'port': r.get_port('sdp_ingest_1_katcp'), 'output_int_time':2, 'antennas':4, 'continuum_factor': 32, 'sd_continuum_factor': 128, 'cbf_channels': 32768,\
