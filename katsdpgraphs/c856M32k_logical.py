...
def build_physical_graph(r):
    ...
    G.add_node('sdp.ingest.1',{'port': r.get_port('sdp_ingest_1_katcp'), 'antennas':4, 'continuum_factor': 32, 'sd_continuum_factor': 128, 'cbf_channels': 32768,\
    ...
    G.add_edge('cbf.output.1','sdp.ingest.1',{'cbf_spead':'{}:{}'.format(r.get_multicast_ip('c856M32k_spead'), r.get_port('c856M32k_spead'))})
